...
<head>
  ...
  <title>Compras | <?php echo $nombre['nombre'] ?></title>
            ...
            <div class="card">
              <div class="card-header bg-primary">
                <!-- <h3 class="card-title">DataTable with default features</h3> -->
                 <h4><i class="fas fa-calendar-alt"></i> Datos Orden</h4> 
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <form action="" method="post" id="datos_factura">  
                    ...
                    <div class="form-group"> 
                        <label for="Nombres_Apellidos" class="col-control-label font-weight-bold Negrita">Proveedor</label>
                        
                        <select class="proveedor form-control" name="cliente" id="id_proveedor" required>
                        ...
                        <div class="col-lg-3">
                    <div class="form-group"> 
                        <label for="Nombres_Apellidos" class="col-control-label font-weight-bold Negrita">fecha orden</label>
                        ...
                        <div class="col-lg-3">
                    <div class="form-group"> 
                        <label for="Nombres_Apellidos" class="col-control-label font-weight-bold Negrita">Iva</label>
                    ...
                    <div class="col-lg-3">
                    <div class="form-group"> 
                        <label for="Nombres_Apellidos" class="col-control-label font-weight-bold Negrita">Usuario</label>
                    ...
                    <div class="col-lg-3">
                        <label for=""></label>
                        <div class="form-group">
                        <button type="submit" class="btn btn-success" id="datos_factura"><i class="fa fa-print"></i> Guardar orden</button>
                    </div>    
                </div>
                    </div>
                    ...
                    <h4 class=""><i class="fas fa-shopping-cart"></i> Datos  compra</h4>
                    </div>
                    <br>
                    <div class="row">
...
$(document).ready(function() {
    ...
    minimumInputLength: 2
		...
		var preciocompra = $('.producto').select2('data')[0].costo;
		$('#stock').val(stock);
		$('#codigo').val(codigo);
...
function agregar ()
	...
	$.ajax({
        ...
        $("#datos_factura").submit(function(){
		  ...
		  var id_usuario = $("#id_vendedor").val();
		  var iva = $("#iva").val();
          var abono = $("#descuento_input").val();
		
		
          VentanaCentrada('./pdf1/factura.php?id_proveedor='+id_proveedor+'&id_usuario='+id_usuario+'&iva='+iva,'Factura','','1024','768','true');
	 	});
