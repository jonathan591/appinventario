...
if($id>0){
    ...
    if($result!=null){
        if(mysqli_num_rows($result)>0){
            ...
            $NombresApellidos=$usuarioA['nombre'];
    ...
    $('#IdUsuario').val(<?php echo $id; ?>);
     $('#guardar_estudiante').bind("submit", function (){
       ...
       $.ajax({
           ...
           url:'ajax/grabar_proveedor.php',
           data:$(this).serialize(),
           success: function (data){
               $("#resultados_usuario").html(data);
               listar('ajax/listar_proveedor.php');
           }
       }); 
       return false;
    });
           ...
           <div class="modal-body">
                <form class="form-horizontal" method="post" id="guardar_estudiante" name="guardar_estudiante">
                    ...
                    <div class="form-group"> 
                        <label for="Nombres_Apellidos" class="col-control-label font-weight-bold Negrita">Nombres:</label>
                        
                            <input type="text" minlength="10" id="myInput"  autocapitalize="words" name="nombre_txt" class="form-control" value="<?php echo $NombresApellidos; ?>" required placeholder="ingrese su nombre "/>
                        </div>
                    </div>
                    <div class="col-lg-4">
                    <div class="form-group"> 
                        <label for="descripcion" class="col-control-label font-weight-bold Negrita">Descripccion:</label>
                        
                            <input type="text"  autocapitalize="words" name="descripcion_txt" class="form-control" value="<?php echo $descripcion; ?>" required placeholder="ingrese la descripcion "/>
                        </div>
                    </div>
                        <div class="col-lg-4">
                     <div class="form-group">
                        <label for="Cedula" class="col-control-label font-weight-bold Negrita">Ruc:</label>
                        
                            <input type="number" minlength="10" id="Nombres"  name="Ruc_txt" class="form-control" value="<?php echo $Cedula; ?>" required placeholder="ingrese su cedula"/>
                        </div>
                    </div>
                        </div>
                    <div class="row">
                        <div class="col-lg-6">
                     <div class="form-group">
                        <label for="Telefono" class="col-control-label font-weight-bold Negrita">Telefono:</label>
...
<div class="col-lg-6">
                ...
                <button type="submit" class="btn btn-primary" id="guardar_estudiante"><i class="fas fa-save"></i> Guardar Proveedor</button>
            </div>
