...
<head>
  ...
  <title>Producto | <?php echo $nombre['nombre'] ?></title>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <button type='button' class="btn btn-primary" data-toggle="modal" onclick="NuevoProducto();" ><i class="fas fa fa-solid fa-plus"></i>  Agregar Producto </button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
$(document).ready(function(){
  ...
  $.ajax({
    ...
    beforeSend: function() {
      $('#loading').show('carganado'); // muestra el GIF de carga antes de la petición AJAX
    },
