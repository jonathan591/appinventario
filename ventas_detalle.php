...
<head>
  ...
  <title>ventas producto | <?php echo $nombre['nombre'] ?></title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Ventas Producto</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
function imprimir_factura(id_factura){
            ...
            VentanaCentrada('./pdf1/ver_factura_venta.php?id_factura='+id_factura,'Factura','','1024','768','true');
		}
