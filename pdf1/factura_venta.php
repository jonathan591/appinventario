<?php
	...
	$codigo_venta="VECO".$numero_factura;
   ...
   $pdf->Cell(0.1, 9, '', 'R');
	...
	$pdf->SetTextColor(39,39,51);
	$pdf->Cell(35,7,utf8_decode(strtoupper("Factura Nro.")),1,0,'C');
	...
	$pdf->SetFont('Arial','',10);
	$pdf->SetTextColor(39,39,51);
	$pdf->Cell(20,7,utf8_decode("Cliente:"),1,0);
	$pdf->SetTextColor(97,97,97);
	$pdf->Cell(60,7,utf8_decode($rw_cliente['nombres_apellidos']),1,0,'L');
	$pdf->SetTextColor(39,39,51);
	$pdf->Cell(30,7,utf8_decode("Doc: "),1,0,'L');
	$pdf->SetTextColor(97,97,97);
	$pdf->Cell(30,7,utf8_decode("CD:".$rw_cliente['cedula']),1,0,'L');
	$pdf->SetTextColor(39,39,51);
	...
	$pdf->Cell(30,7,utf8_decode("Forma de pago: "),1,0,'L');
	$pdf->SetTextColor(97,97,97);
	$pdf->Cell(30,7,utf8_decode($estdo),1,0,'L');
	$pdf->SetTextColor(39,39,51);
...
$insert=mysqli_query($objConexion,"INSERT INTO ventas (numero_factura,fecha_factura,id_clientes,id_usuario,condiciones,total_venta,estado_factura,codigo_venta,iva)VALUES ('$numero_factura','$date','$id_cliente','$id_vendedor','$condiciones','$total_factura','1','$codigo_venta','$iva')");
$delete=mysqli_query($objConexion,"DELETE FROM tmp WHERE tmp.id_session='$session_id'");
	...
	$pdf->Output("I","venta_Nro_".$numero_factura.".pdf",true);