<?php
 ...
 $pdf->Cell(0.1, 9, '', 'R');
	...
	$pdf->SetTextColor(102,97,97);
	$pdf->Cell(30,7,utf8_decode("".$rw_cliente['cedula']),1,0,'L');
	$pdf->SetTextColor(39,39,51);
	$pdf->Cell(10,7,utf8_decode("Tel:"),1,0,'L');
	$pdf->SetTextColor(92,97,97);
	...
	$pdf->Cell(30,7,utf8_decode(" tipo pago: "),1,0,'L');
	$pdf->SetTextColor(97,97,97);
    ...
    $pdf->Cell(190, 10, utf8_decode('Detalle de la Factura'), 0, 1, 'C');
	# Tabla de productos #
	$pdf->SetFont('Arial','',9);
