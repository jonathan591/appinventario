					...
					<?php 
						...
						<tr>
							...
							<td><span class="label label-<?php echo $class; ?>"><?php echo $estado?></span></td>
                                                        ...
                                                        ?>
                                                         <button  class='btn btn-info' title='Editar Cliente' onclick="editarCliente(<?php echo $fila['id_clientes']?>)"><i class="fas fa-edit"></i></button>
                                                            <?php 
                                                           }
                                                           if($idrolUsuario==1){
                                                            ...
                                                            ?>
                                                            <button  class='btn btn-danger' title='Eliminar Cliente' onclick="eliminarCliente(<?php echo $fila['id_clientes']?>)"><i class="fas fa fa-solid fa-trash"></i></button>
                                                       <?php  }?>
