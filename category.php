...
<head>
  ...
  <title>Categoria | <?php echo $nombre['nombre'] ?></title>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <button type='button' class="btn btn-primary" data-toggle="modal" onclick="NuevoCat();" ><i class="fas fa fa-solid fa-plus"></i>  Agregar Categoria </button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
